...
class AmapRouteClient:
    ...
    def __init__(
        ...
        *,
        ...
        self.key = key or os.getenv("AMAP_WEB_SERVICE_KEY")
        if not self.key:
            raise AmapConfigError("AMAP_WEB_SERVICE_KEY is required")
        ...
        self.timeout_seconds = timeout_seconds or _read_timeout_seconds()
    ...
    async def __aenter__(self) -> "AmapRouteClient":
        return self
